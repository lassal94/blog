...
from django.urls import path, include # подключаем библиотеки
from users import views as userViews #импортируем из приложения users файл
from django.contrib.auth import views as authViews
from django.conf import settings #импортируем файл settings.py
from django.conf.urls.static import static #надо документацию читать короче
